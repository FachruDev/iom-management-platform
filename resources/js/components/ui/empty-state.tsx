...
export function EmptyState({ title = 'Tidak ada data', description = 'Data akan muncul setelah tersedia.' }: { title?: string; description?: string }) {
    return (
        <div className="flex min-h-60 flex-col items-center justify-center rounded-[24px] border border-dashed border-slate-200 bg-slate-50/40 p-8 text-center backdrop-blur-xs">
